           ...
           btn_confirmprice.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   if(!(et_jobtitle.getText().toString().isEmpty()) && !(et_jobdesc.getText().toString().isEmpty()) && !(et_time.getText().toString().isEmpty())) {
                       ...
                       Intent intent = new Intent(JobDescriptionActivity.this, RatingActivity.class);
...
//            et_jobtitle.setText("");
          ...
          Toast.makeText(JobDescriptionActivity.this,"cannot be empty",Toast.LENGTH_LONG).show();
